        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <div className="bg-white rounded-lg overflow-hidden shadow-sm">
            <div className="relative bg-gray-200 h-40">
              {/* Placeholder for energy waves image */}
            ...
            <div className="p-3">
              <h3 className="text-gray-800 font-medium text-sm truncate">Feel And Relax Your Mind</h3>
          ...
          <div className="bg-white rounded-lg overflow-hidden shadow-sm">
            <div className="relative bg-gray-200 h-40">
              {/* Placeholder for mountain lake image */}
              <button className="absolute top-2 right-2 w-8 h-8 bg-white bg-opacity-70 rounded-full flex items-center justify-center">
          ...
          <div className="bg-white rounded-lg overflow-hidden shadow-sm">
            <div className="relative bg-gray-200 h-40">
              {/* Placeholder for wildflower field image */}
              <button className="absolute top-2 right-2 w-8 h-8 bg-white bg-opacity-70 rounded-full flex items-center justify-center">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-red-500" viewBox="0 0 20 20" fill="currentColor">
                  <path fillRule="evenodd" d="M3.172 5.172a4 4 0 015.656 0L10 6.343l1.172-1.171a4 4 0 115.656 5.656L10 17.657l-6.828-6.829a4 4 0 010-5.656z" clipRule="evenodd" />
                </svg>
