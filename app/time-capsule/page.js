...
export default function TimeCapsule() {
  ...
  // Simple memory entries without complex syntax
  const memoryEntries = [
    {
      id: 1,
      date: "March 28, 2025",
      title: "First Meditation Milestone",
      description: "Completed 7 consecutive days of morning meditation!",
      category: "mind"
    },
    {
      id: 2,
      ...
      description: "Beautiful sunrise during my morning run.",
      category: "body"
    },
    {
      id: 3,
      ...
      description: "Started my gratitude practice.",
      category: "spirit"
    }
  ];
